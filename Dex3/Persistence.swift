...
struct PersistenceController {
    static let shared = PersistenceController() //initializing persistence controller.  Static lets us use the same one throughout the entire app?
